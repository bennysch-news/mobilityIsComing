...
3. Assign the API key as new organization secret at https://github.com/organizations/bennysch-news/settings/secrets/actions/new  
   * Name:  **NEWSAPI_KEY**   
   * Value: **Your key here**   
...
1. Please register with username (i.e.: bennysch_news) at https://www.geonames.org/login  
2. Assign the choosen username as new organization secret at https://github.com/organizations/bennysch-news/settings/secrets/actions/new  
   * Name:  **GEONAMES_KEY**   
